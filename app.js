...
function loadTeam() {
  ...
  document.querySelector(".action-btn.skip").style.display =
    isSingleTeamMode ? "none" : "inline-block";
...
window.startAllTeams = function () {
  ...
  document.querySelector(".action-btn.skip").style.display = "inline-block";
...
window.startSingleTeam = function (teamName) {
  ...
  document.querySelector(".action-btn.skip").style.display = "none";
